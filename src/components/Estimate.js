...
const Estimate = props => {
    ...
    const getPlatforms = () => {
        ...
        if(questions.length > 2) {
            ...
            ).map(question => question.options.filter(
                option => option.selected)
                    ...
                    <Grid container>
                        <Grid item container direction="column" md={7}>
                            ...
                            <Grid item>
                                ...
                                <Typography variant="body1" paragraph>FIll out your name, phone, number and email, place your 
                                requests, and we'll get back to you with details moving forward 
                                and a final price</Typography>
                            </Grid>
                        </Grid>
                            ...
                            <Grid item>
                                <Grid container direction="column">
                                    ...
                                    <Grid item container alignItems="center">
                                        ...
                                        <Grid item>
                                            <Typography body="body1">Second options check</Typography>
                                        </Grid>
                                    </Grid>
                                    <Grid item container alignItems="center">
                                        <Grid item>
